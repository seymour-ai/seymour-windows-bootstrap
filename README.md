...
To initialize state, register Scheduled Tasks, start OpenClaw, and run the health check:

```powershell
$script = "$env:TEMP\install-seymour.ps1"; Invoke-WebRequest "https://raw.githubusercontent.com/seymour-ai/seymour-windows-bootstrap/main/install.ps1" -OutFile $script; powershell -ExecutionPolicy Bypass -File $script -InstallTasks
```
